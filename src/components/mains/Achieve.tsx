import {StyledH2, ExpList, StyledMainH1, StyledMain, StyledH3} from "./../../components/styles";
    ...
    return (
        <StyledMain>
            ...
            <ExpList>
                ...
                <li>Successful Transfer Student - Maintained 3.5+ GPA during transition</li>
            ...
            <ExpList>
                ...
                <li>Python - Basic to Intermediate (data structures, simple scripts)</li>
